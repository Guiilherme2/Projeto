...
<head>
  ...
  <title>Cadastro - Casa de Patricia</title>
            ...
            <div class="form-row profile-row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                              <label style="color: #0a0a0a;">Foto</label>
                              <br>
                              <span class="btn btn-primary btn-lg form-btn btn-file"></i>Buscar Foto 
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-12 col-md-5">
                            <div class="form-group">
                                ...
                                <input placeholder="(00) 00000-0000" class="form-control form-control-lg telefone" type="text" inputmode="numeric" name="contato">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-3">
                    ...
                    <div class="form-row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                              ...
                              <input class="form-control form-control-lg" type="text" name="pai">
                            </div>
                        </div>

                        <div class="col-sm-12 col-md-6">
                            <div class="form-group">
                              <label style="color: #0a0a0a;">Nome da Mãe</label>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group"><label style="color: #0a0a0a;">CPF*</label>
                                <input required="" class="form-control form-control-lg" type="text" id="CPF" autofocus="" name="cpf"></div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group">
                              <label style="color: #0a0a0a;" for=""><strong>Informações Médicas</strong></label>
                                ...
                                <div class="form-group">
                                    <label style="color: #0a0a0a;" for="">É alergico a alguma coisa? A quê?</label>
                                    <input type="text" class="form-control" name="alergias" id="" aria-describedby="helpId" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label style="color: #0a0a0a;" for="">Tem intolerância? A quê?</label>
                    ...
                    <div class="form-row">
                        <div class="col-sm-12 col-md-6">
                          <div class="form-group">
                            <label style="color: #0a0a0a;">Responsável Familiar</label>
                              <input class="form-control form-control-lg" type="text" name="nome_familiar">
                          </div>
                      </div>
                      <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                          <label style="color: #0a0a0a;">Contato Familiar</label><br>
